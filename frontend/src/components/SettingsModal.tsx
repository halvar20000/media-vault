...
const SECRET_KEYS: { f: keyof KeysStatus; label: string; group: string }[] = [
  ...
  { f: 'discogsToken', label: 'Discogs token', group: 'Music — Discogs (optional: without it, MusicBrainz is used — no key needed)' },
  { f: 'discogsKey', label: 'Discogs consumer key', group: 'Music — Discogs (optional: without it, MusicBrainz is used — no key needed)' },
  { f: 'discogsSecret', label: 'Discogs consumer secret', group: 'Music — Discogs (optional: without it, MusicBrainz is used — no key needed)' },
